    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <select name="perfil" id="perfil" class="form-control">
                ...
                <?php if($usuario['perfil'] == 'Administrador'):?>selected<?php endif; ?> >
                    Administrador
                </option>
                <option value="Moderador" 
                <?php if($usuario['perfil'] == 'Moderador'):?>selected<?php endif; ?> >
                    Moderador
                </option>
            </select>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="estadoActivo" 
                        name="estado" <?php if($usuario['estado'] == '1'):?>checked<?php endif; ?> 
                        value="1">
                ...
                <div class="col-sm-6">
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="estadoInactivo" 
                        name="estado" <?php if($usuario['estado'] == '0'):?>checked<?php endif; ?> 
                        value="0">
